    ...
    sections: [
      {
        ...
        paragraphs: [
          "Each system service includes 1 return-air grille maintenance check & filter clean. If you have more than 1 of these in your property, please add them as additional to your order.",
        ],
      },
      {
        kind: "dont",
