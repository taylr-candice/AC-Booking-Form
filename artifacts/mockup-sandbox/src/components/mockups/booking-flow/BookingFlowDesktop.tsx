...
const STEPS: readonly Step[] = [
  ...
  { id: 2, label: "Your AC",         url: "/__mockup/preview/booking-pages/AcDesktop" },
  { id: 3, label: "Property access", url: "/__mockup/preview/booking-pages/AccessDesktop" },
  { id: 4, label: "Pick a slot",     url: "/__mockup/preview/booking-slots/SlotsDesktop" },
  { id: 5, label: "Review & pay",    url: "/__mockup/preview/booking-pages/PayDesktop" },
];
  ...
  const handleIframeLoad = useCallback(() => {
    ...
    const handler = (e: Event) => {
      ...
      const next = nextStepId({ access_method: fresh.access_method }, fresh.current_step);
        ...
        // emitted by `SlotsAccessBanner` (`button-change-access-desktop`
        // / `button-edit-access-desktop` / etc.) so both the
              ...
              <div key={stepId} className="flex items-center">
                ...
                {idx < visible.length - 1 && (
                  <div 
                    ...
                    style={{ backgroundColor: isComplete ? "#ED017F" : "#E2E8F0" }} 
                  />
                )}
              </div>
            );
