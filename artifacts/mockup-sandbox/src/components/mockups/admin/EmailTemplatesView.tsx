...
import { ArrowDownWideNarrow, Edit3, GripVertical, Mail, Pin, Plus, Star, Trash2, X } from "lucide-react";
      ...
      {templates.length > 0 ? (
        <div className="flex items-center justify-end gap-2 text-[12px] text-slate-600">
          ...
          <div
            ...
            data-testid="sort-toggle-email-templates"
            data-sort-mode={sortMode}
          >
            <button
              type="button"
              onClick={() => setSortMode("default")}
              data-testid="button-sort-email-templates-default"
            ...
            <button
              ...
              data-testid="button-sort-email-templates-most-used"
            ...
            <button
              ...
              data-testid="button-sort-email-templates-most-referenced"
                        ...
                        (() => {
                          ...
                          const positionLabel =
                            movableIdx >= 0
                              ...
                              : "";
                          const isSortDisabled = sortMode !== "default";
                          return (
                            <button
                              type="button"
                              ...
                              aria-label={
                                isSortDisabled
                                  ? `Drag-to-reorder is disabled while sorted by usage`
                                  : `Reorder "${t.name}".${positionLabel} Press Up or Down arrow to move, Home or End to jump to top or bottom.`
                              }
                              aria-keyshortcuts={isSortDisabled ? undefined : "ArrowUp ArrowDown Home End"}
                              title={
                                isSortDisabled
                                  ? "Switch back to Default order to drag-reorder rows"
                              ...
                              className={
                                isSortDisabled
                                  ? "inline-flex h-7 w-5 cursor-not-allowed items-center justify-center rounded text-slate-300 focus:outline-none"
